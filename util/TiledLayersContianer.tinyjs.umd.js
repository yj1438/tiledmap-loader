...
var _default = Tiny.TiledLayersContianer = /*#__PURE__*/function (_Tiny$Container) {
  (0, _inheritsLoose2["default"])(TiledLayersContianer, _Tiny$Container);

  function TiledLayersContianer(tiledJsonData, resource) {
    var _this;

    _this = _Tiny$Container.call(this) || this;
    _this.childrenMap = {};
